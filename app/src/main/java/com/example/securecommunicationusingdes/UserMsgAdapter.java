...
public class UserMsgAdapter extends ArrayAdapter<ResponseMessage> {
    Context context;
    String check = "";
    ...
    public UserMsgAdapter(Context context, ArrayList<ResponseMessage> responseMessages) {
        super(context, R.layout.item_user, responseMessages);
    ...
    public View getView(final int position, View convertView, ViewGroup parent)  {
        ...
        if (convertView == null) {
            ...
            check = responseMessage.getFirst_name().toString();
            viewHolder.usertName.setText("" + responseMessage.getFirst_name() );
            viewHolder.userMobile.setText("" + responseMessage.getMsg() + " ");
        setImage(viewHolder.userPic,responseMessage.getProfile_pic());
