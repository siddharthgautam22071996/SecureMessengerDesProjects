...
public class UserListAdapter extends ArrayAdapter<ResponseUserContact> {
    Context context;
    ...
    public UserListAdapter(Context context, ArrayList<ResponseUserContact> responseUserContacts) {
